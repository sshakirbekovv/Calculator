...
interface PadProps {
  ...
  onSquartButtonClick?: () => void;
  onFactorialButtonClick: () => void;
}
...
export const Pad: React.FC<PadProps> = ({
  ...
  return (
    <StyledPad>
      ...
      <Button color="dark" onClick={onSquareButtonClick}>
        x<sup>2</sup>
      </Button>
      <Button color="dark" onClick={onSquartButtonClick}>
        x<span>&#8730;</span>2
      </Button>
      <Button color="dark" onClick={onFactorialButtonClick}>!</Button>
      <Button color="dark" onClick={() => onOperatorButtonClick("E")}>
        x<sup>y</sup>
      </Button>
      ...
      <Button color="green" isLarge onClick={onEqualButtonClick}>
        =
      </Button>
    </StyledPad>
  );
